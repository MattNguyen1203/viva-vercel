...
function VideoReview({ data, videoInfo }) {
  ...
  return (
    <div className='relative w-[35.1875vw] h-[47.5vw] rounded-[1vw] bg-[#ccc]' onClick={() => setIsPlay(!isPlay)}>
      <video width='100%' controls={isPlay} ref={videoRef} className='w-full h-full'>
