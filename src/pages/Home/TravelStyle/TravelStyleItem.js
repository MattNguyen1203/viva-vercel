...
import img from '@/assets/images/travel-style.png'
  ...
  return (
    <div className='relative w-[26.25vw] travel-style z-10'>
      ...
      <div className='info absolute top-0 pt-[2vw] px-[2.5vw] z-10'>
        <h3 className='text-white text-[2.125vw] font-[600] leading-[1.2] capitalize'>{data?.banner?.travelStyleInfo?.travelStyleName}</h3>
        <p
