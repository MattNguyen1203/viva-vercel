...
import Banner from '@/pages/HotDeal/Banner'
import Price from '@/pages/TourDetail/Price'
    ...
    <div className='md:mt-[10.8125vw] relative'>
      <header className='relative'>
        ...
        <div className='md:hidden block'>
          <TourDetailBannerMobile data={banner || {}} headerData={bannerHeaders} />
        </div>
        <Image src={promoBg} alt='' className='md:block hidden w-full h-full absolute top-0 left-0 -z-[1]' />
      </header>
      {/* main content */}
      <main className='relative'>
        <div className='md:block hidden'>
          <Image src={tour} alt='' className='absolute top-0 left-0 w-full h-[150vw] opacity-5 z-0' />
          <div
